...
sudo apt install -y emacs27-common                                                                                                                                              # .emacs.d copied above                                                                 git clone -b develop https://github.com/syl20bnr/spacemacs ~/.emacs.d                                                                                                           #LANG is required for spacemacs home screen, else the logo is question marks            echo export LANG=en_US.UTF-8 >> ~/emacs.sh                                              echo TERM=xterm-256color emacs -l ~/src/qg/q_utils_orig/_load-all-min.elc >> ~/emacs.sh               
