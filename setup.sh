...
type emacs || ( sudo apt install -y emacs-nox ; )
...
screen -dmS e
screen -S e -X stuff 'TERM=xterm-256color emacs --eval "(kill-emacs)" && echo emacs_done > /var/tmp/emacs_done && ~/dotfiles-spacemacs/msg_mobile.sh DONE \n'
screen -ls
