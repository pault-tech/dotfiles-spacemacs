...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     (python :variables
             python-backend 'lsp   ;; see comment below for pylsp
             python-lsp-server 'pylsp
             python-test-runner 'pytest
             ;; '(pytest-cmd-format-string "cd '%s' && poetry run %s %s '%s'") added below to custom-set-variables, see myconfigs
     ...
     ;; spell-checking
     syntax-checking  ;; enables spc e l
     ;; version-control
     treemacs
...
This function is called at the very end of Spacemacs initialization."
  (custom-set-variables
   ...
   ;; TODO this path may be incorrect
   '(lsp-eslint-server-command
     `("node" "/home/ubuntu/.emacs.d/.cache/lsp/eslint/unzipped/extension/server/out/eslintServer.js" "--stdio"))
   ...
   '(pytest-cmd-format-string "cd '%s' && poetry run %s %s '%s'")  ;; myconfigs
   )
  (custom-set-faces
